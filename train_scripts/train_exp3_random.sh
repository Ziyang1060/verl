# set -x
# (bash /mnt/ali-sh-1/usr/huaan1/ocean/code/verl/train_scripts/train_exp3_random.sh &)
...
export MASTER_ADDR="10.148.18.107"
export WORLD_SIZE=5
...
export exp_name='GRM_exp3_1_grpo_redone_sft_v4_pev5_5w_s1150_random'

# Paths
export MODEL_PATH="/mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/GRM_exp3_grpo_redone_sft_v4_pev5_5w/global_step_1150/hf_model"
...
#     --backend fsdp \
#     --local_dir /mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/GRM_exp1-1_step_grpo_redone_sft_v4_pev5_5w-no_FTT/global_step_1200/actor \
#     --target_dir /mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/GRM_exp1-1_step_grpo_redone_sft_v4_pev5_5w-no_FTT/global_step_1200/hf_model
