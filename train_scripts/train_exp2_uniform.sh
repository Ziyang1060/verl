# set -x
# (bash /mnt/ali-sh-1/usr/huaan1/ocean/code/verl/train_scripts/train_exp2_uniform.sh &)
...
export MASTER_ADDR="10.148.8.206"
export WORLD_SIZE=5
...
export exp_name='GRM_exp2_grpo_redone_sft_v2_general_pe'
...
extreme_multi_epochs_pev0="/mnt/ali-sh-1/usr/huaan1/ocean/data/rl/relone_rl_v1_3epochs_uniform_random.pev0.train.parquet"
train_files="['$uniform_pev0']"
...
# 需要手动去 ppo_trainer.yaml 更换
# --data.val_files "['/mnt/ali-sh-1/usr/huaan1/ocean/data/testset/tiny/0226_tiny_random_sample_wtax_unbiased_20250719.process.pev0.train.parquet', '/mnt/ali-sh-1/usr/huaan1/ocean/data/testset/tiny/0226_tiny_uniform_sample_wtax_biased.process.pev0.train.parquet', '/mnt/ali-sh-1/usr/huaan1/ocean/data/testset/tiny/0320_tiny_longtail_sample_wtax_biased.process.pev0.train.parquet', '/mnt/ali-sh-1/usr/huaan1/ocean/data/testset/tiny/knowledge_good_click_note_test_1k_biased.process.pev0.train.parquet']" \
...
#     --backend fsdp \
#     --local_dir /mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/exp1-8-redone-sft-v3-rl-v1_no_hard_biased_pev5_process_no_kl_wa_step1975_no_kl_no_wa/global_step_400/actor \
#     --target_dir /mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/exp1-8-redone-sft-v3-rl-v1_no_hard_biased_pev5_process_no_kl_wa_step1975_no_kl_no_wa/global_step_400/hf_model