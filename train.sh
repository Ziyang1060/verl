...
export exp_name='exp2-1_qwen2.5-cft-sft-rl-v2_random_no_kl-vsRedOne'

# Paths
export MODEL_PATH="/mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/models/qwen2.5-cft_32B-rel_sft_v2"
...
bash scripts/run_dist.sh \
  ...
  --actor_rollout_ref.actor.optim.num_cycles 5 \
  ...
  --trainer.resume_from_path "/mnt/ali-sh-1/usr/huaan1/ocean/code/verl_checkpoint_save/exp2-1_qwen2.5-cft-sft-rl-v2_random_no_kl-vsRedOne/global_step_2700" \
