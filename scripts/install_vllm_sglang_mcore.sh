...
FILE="flash_attn-2.7.4.post1+cu12torch2.6cxx11abiFALSE-cp310-cp310-linux_x86_64.whl"
if [ ! -f "$FILE" ]; then
    echo "文件不存在，开始下载..."
...
FILE="flashinfer_python-0.2.2.post1+cu124torch2.6-cp38-abi3-linux_x86_64.whl"
if [ ! -f "$FILE" ]; then
    echo "文件不存在，开始下载..."
