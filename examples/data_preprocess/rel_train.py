...
course_stage = "all"
data_source = f"rel_train_process"
# data_source = f"rel_train_c{course_stage}"
...
print(len(train_dataset))
train_dataset.to_parquet(dataset_path.replace(".jsonl", ".process.train.parquet"))